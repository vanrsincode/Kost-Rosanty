...
let body_nicescroll_opts = {
     cursorborder: "0",
     cursorcolor: "#424242a1",
     cursorwidth: "6px",
     cursoropacitymin: 0,
     cursoropacitymax: 0.8,
     zindex: 892,
     touchbehavior: false,
     preventmultitouchscroll: false
};

// Fungsi untuk inisialisasi NiceScroll hanya di desktop
function initializeNiceScroll() {
     if ($(window).width() > 1024) { // Desktop: width lebih dari 768px
          if (!$("body").getNiceScroll().length) {
               $("body").niceScroll(body_nicescroll_opts);
          }
     } else {
          // Mobile: width <= 768px, hapus NiceScroll jika aktif
          if ($("body").getNiceScroll().length) {
...
// Observer untuk memperbarui NiceScroll jika ada perubahan DOM
...
$(function () {
     ...
     var update_sidebar_nicescroll = function () {
          let a = setInterval(function () {
               ...
               // if (body_nicescroll != null) {
               //      body_nicescroll.resize();
               // }
          }, 100);
     ...
     var sidebar_dropdown = function () {
          if ($(".main-sidebar").length) {
               ...
               // $("body").niceScroll(body_nicescroll_opts);
               // body_nicescroll = $("body").getNiceScroll();
